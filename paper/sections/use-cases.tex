...
Blockchain technology can be used to track material assets that are globally 
...
%This could be useful in determining suspicious activity (e.g., having an age that is not increasing linearly).
...
%
%Asset tracking and identity tracking are both examples of sharing data across organizations, with Blockchain technology providing a common environment.
...
% Scott: Removed because this is largely based on work proposed at MIT Lincoln Lab. Only tangentially supported by the research.
