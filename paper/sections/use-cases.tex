...
% Jeremy: swaps present and future
% Jeremy: utility and risk management and variance in cash flows
...
% Jeremy: previously \paragraph{Regulation and sanctions}
% Jeremy: add contracts and regulatory holdbacks, etc
% Jeremy: set of default actions that can be overridden in court
% Jeremy: defaults on loans, cease trades on insolvency, etc
...
% Jeremy: generalization of above, also mention LVTS
...
% Jeremy: I didn't get to this yet
