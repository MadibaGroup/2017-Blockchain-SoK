...
\textit{shared governance and operation}, \textit{verifiable state}, and {resilience to data loss}.
...
Data tracked by a Blockchain system can be permissioned; while these permissions could be tracked using traditional access control paradigms, most often they are regulated cryptographically.
