...
This principle was put to the test when the DAO was hacked. \textbf{Get details of DAO hack right and add citation.} 

% JC: I write out with the DAO attack details if you tell me how long you want it


\textbf{Do we need a short survey of work on smart contract verification here? I know there are some papers.}
