...
Our concept map shows interconnections between features and use cases. We also coded challenges -- problems hindering the use of Blockchain that do not currently have satisfactory solutions -- and limitations, which are inherent deficits of the technology. In this section, we will list the challenges and limitations that we coded. Discussion is deferred to \textbf{section XX}.
...
\paragraph{A reputation for illicit uses}
"Pseudonymity and avoidance of banks and authorities is driven by the desire to circumvent laws and regulations"
