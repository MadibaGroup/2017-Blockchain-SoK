...
Our grounded theory analysis of industry documents resulted in the creation of 25 technical primitives, 17 technical properties, 12 normative properties, 11 capabilities, and 19 use case categories.
...
In this section, we describe how our results provide answers to two of our questions:  (1) what exactly is Blockchain technology (i.e., what are its properties) and (2) what capabilities does it provide.

\subsection{Blockchain Technology's Technical Properties}
...
\begin{figure*}
	\includegraphics[width=\textwidth]{figures/technical-properties}	
...
\subsubsection{Cryptographic Append-Only Ledger}
