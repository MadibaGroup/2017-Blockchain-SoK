...
\jnote{While I personally understand this section, I don't think a general audience will. It might help to give examples (what is an example of a transaction, valid/invalid, a consensus rule, etc.) without losing the generality. It needs some polish to make it more relatable.}
