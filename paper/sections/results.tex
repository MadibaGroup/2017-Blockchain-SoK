...
Challenges:
1. Verification of smart contract correctness
 a. If code is law, bugs are law
2. Stapling on-chain tokens to off-chain assets
 a. You can enforce rules on on-chain tokens, but you can?t enforce them on the assets those tokens represent
3. Leveraging off-chain oracles without compromising auditability
 a. Functionality outside of the blockchain is difficult to verify later
4. A reputation for illicit uses
 a. ?Pseudonymity and avoidance of banks and authorities is driven by the desire to circumvent laws and regulations?
\newline
Limitations
1. Wastefulness, both in replicated storage of data and proof-of-work consensus protocols
 a. Bitcoin consumes as much energy as the country of Denmark, and it appears that it will continue to grow
2. Emergent centralization of blockchain maintainers
 a. Bitcoin?s hash puzzle has resulted in concentration of compute power; alternatives like proof-of-stake still have this concern
3. Scalability of public blockchains
 a. Bitcoin?s skyrocketing transaction fees and delays illustrate this limitation
4. Dispute resolution and rollback of mistakes 
 a. A payment system must be able to reverse fraudulent transactions. This conflicts with the immutability property of Blockchain.
