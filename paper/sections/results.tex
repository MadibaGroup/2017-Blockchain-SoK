...
\bnote{Detection of modification isn't really resilience, is it? For edges c-h and d-i I think we can drop it from the figure and just mention it in the text... let the figure focus on what the system can recover from.}
