...
This is not to say that such systems lack value---such an evaluation is beyond the scope of this paper---but rather that we believe these types of systems are distinct from the more decentralized Blockchain technology.
...
\snote{Discuss more about properties here. Centered around decentralized governance.}
