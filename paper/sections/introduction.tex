...
Based on this analysis of data from industry, interspersed with our own knowledge and a review of the academic literature, we are able to answer the four questions commonly asked in relation to Blockchain technology.
...
\begin{enumerate}
	...
	\item \textbf{Detailing open challenges in the area of Blockchain technology.}
...
%	In this paper, we also survey the academic research that has already been conducted in regards to Blockchain technology.
	...
	\item \textbf{Identifying use cases that are most likely to benefit from Blockchain technology.}
	We identify sixteen use cases that could leverage Blockchain technolgoy 
	
	
	classes of applications for Blockchain technology.
	...
	%TODO: I think this will move the appendix.
