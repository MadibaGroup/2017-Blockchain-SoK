...
%As usage of Blockchain applications such as Bitcoin has grown, questions have been raised about their scalability, cost, and performance.
...
Users and developers of blockchain systems both face usability challenges. For users, one of the biggest hurdles to widespread use is the requirement that they store, manage, and secure cryptographic keys. %Key management is needed to certify users' own transactions, as well as to verify the transactions of others. 
...
\bnote{Looks like this got rolled into UX challenges, so we should delete this subsection?}
